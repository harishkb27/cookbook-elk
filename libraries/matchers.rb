if defined?(ChefSpec)
  ...
  ChefSpec.define_matcher :elk_es_plugin
  ...
  def install_elk_es_plugin(resource_name)
    ChefSpec::Matchers::ResourceMatcher.new(:elk_es_plugin, :install, resource_name)
  end

  def remove_elk_es_plugin(resource_name)
    ChefSpec::Matchers::ResourceMatcher.new(:elk_es_plugin, :remove, resource_name)
  end
